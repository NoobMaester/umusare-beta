    ...
    return (
        <div className="w-full bg-white py-16 px-4">
            <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-4">
                <img className="w-[500px] mx-auto my-4" src={driver} alt="driver" />
                <div className="flex flex-col justify-center">
                    <p className="uppercase text-[#00df9a] font-bold sm:text-center">Data analytics dashboard</p>
                    <h1 className="md:text-4xl sm:text-3xl sm:text-center text-2xl font-bold py-2">Manage Data Analytics Centrally</h1>
